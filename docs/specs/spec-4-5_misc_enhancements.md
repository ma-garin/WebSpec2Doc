...
| 項目 | 値 |
|---|---|
| WBS | 4-5（docs/0703-01_plan.md WBS-4） |
| 優先度 / 見積 | P3 / 各 0.5〜1sp |
| 依存 | 個別（各ミニ仕様に記載） |
...
- [ ] 7 項目すべての「済/未」が実装現物と一致している（レビュー時に grep で再確認）
- [ ] 各項目の分割仕様書番号を予約（SPEC-4-5-1〜4-5-7、§5 の順）し、docs/0703-01_plan.md の WBS-4-5 行から参照できる
